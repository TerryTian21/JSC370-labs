...
The `datasaurus_dozen` dataset has 1846 rows 3 columns corresponding to the variables (dataset, x, y). 
...
# fig.fulwidth=TRUE specifies the output size of the plot
...
```
The corrolation is very similar to the dino dataset and is a small negative value of -0.0629611	.
...
```
Once again, the corrolation is similar to the previous two and is a small negative value of -0.06834336.

Facet by the dataset variable, placing the plots in a 3 column grid, and don't add a legend.

5. Finally, let's plot all datasets at once. In order to do this we will make use of facetting.

```{r all-viz, eval=TRUE, fig.fullwidth=TRUE, fig.height=10, fig.width=7}
